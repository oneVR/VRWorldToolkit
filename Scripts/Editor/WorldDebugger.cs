...
namespace VRWorldToolkit.WorldDebugger
{
    public class WorldDebugger : EditorWindow
    {
        ...
        private static readonly string switchToProgressive = "Current scene is currently using the Enlighten lightmapper, which has been deprecated in newer versions of Unity. You should consider switching to Progressive for improved fidelity and performance.";
