...
namespace VRWorldToolkit.WorldDebugger
{
    public class WorldDebugger : EditorWindow
    {
        ...
        private readonly string noLightmapUV = "Model found in the scene \"%variable%\" is set to be lightmapped but doesn't have Lightmap UVs. This causes issues when baking lighting. You can enable generating Lightmap UV's in the model's import settings.";
